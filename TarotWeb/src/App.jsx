...
function App() {
  ...
  return (
    <div className="relative min-h-screen w-full flex flex-col items-center justify-start md:justify-center p-4 pb-20 overflow-x-hidden">
      <Background />
      <MuteButton />

      <main className="z-10 w-full max-w-6xl flex flex-col items-center gap-8 min-h-[80vh]">
        <h1 className="text-3xl md:text-6xl font-serif text-transparent bg-clip-text bg-gradient-to-r from-mystic-gold to-orange-400 text-center drop-shadow-lg animate-pulse-slow">
          Mystic Tarot
        </h1>
          ...
          <AnimatePresence>
            {gameState === 'analyzing' && (
              ...
              >
                ...
                <p className="text-mystic-gold font-serif text-xl animate-pulse">Đang kết nối vũ trụ...</p>
              </motion.div>
            )}
          </AnimatePresence>
