    ...
    return (
        ...
        >
            <form onSubmit={handleSubmit} className="flex flex-col gap-4 bg-black/40 backdrop-blur-md p-8 rounded-2xl border border-white/10 shadow-2xl">
                <h2 className="text-2xl font-serif text-mystic-gold text-center mb-2">Hỏi Các Vì Sao</h2>
                <p className="text-gray-300 text-center text-sm mb-4">Hãy tập trung suy nghĩ về câu hỏi của bạn, rồi để các lá bài dẫn lối.</p>

                <input
                    type="text"
                    value={question}
                    onChange={(e) => setQuestion(e.target.value)}
                    placeholder="Tương lai của tôi sẽ ra sao?"
